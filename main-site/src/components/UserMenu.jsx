      ...
      <div className="flex flex-row gap-3">
        {user ? (
          ...
          <>
            <Link
              to="/login"
              className="bg-linear-to-r from-[#0d9c06] to-[#0b7e05] text-[15px] hover:shadow-xl cursor-pointer transition-all hover:scale-105 text-white text-sm rounded-xl px-7 py-2.5 flex flex-row gap-1 items-center font-bold"
            >
              Login
            </Link>
            <Button />
