      ...
      <div className="flex flex-row gap-3">
        {user ? (
          ...
          <>
            <Link
              to="/login"
              className="bg-[#0d9c06] text-[15px] hover:bg-[#11c50a] cursor-pointer transition-all text-white text-sm rounded-md px-7 py-2.5 flex flex-row gap-1 items-center"
            >
              Login
            </Link>
            <Button />
