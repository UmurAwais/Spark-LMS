      ...
      <div className="w-full max-w-[1440px] mx-auto font-display">
        ...
        <div className="block sm:hidden px-4 py-8 border-b border-gray-200 w-full">
          <div className="flex flex-col gap-2">
            ...
            <Link to="/contact" className="w-full bg-linear-to-r from-[#0d9c06] to-[#0b7e05] hover:shadow-xl text-white font-bold py-3 px-4 rounded-xl transition-all hover:scale-105 mt-1.5 flex text-center justify-center">
              Get started
            </Link>
            <SearchBar />
          </div>
