          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <Link 
                  to="/contact" 
                  className="w-full bg-linear-to-r from-[#0d9c06] to-[#0b7e05] hover:shadow-xl cursor-pointer transition-all hover:scale-105 text-white text-sm rounded-xl px-7 py-2.5 flex flex-row gap-1 items-center justify-center font-bold"
                >
                  Get Started 
                  <ArrowRight size={14} />
                </Link>
